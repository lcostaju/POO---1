...
public class App {
    ...
    //A aplicação não pode ter as variaveis que representa os numeros interiros e reais
        ...
        do{
            ...
            switch (menu) {
                case '1':
                    ...
                    System.out.println(a1.exibeInt(d1.getA(), d1.getB(), a1.addInt(d1.getA(), d1.getB())));
                    break;
                case '2':
                    Dados1 d2 = new Dados1(10.5f, 20.5f);
                    Adicao1 a2 = new Adicao1();
                    System.out.println(a2.exibeFloat(d2.getC(), d2.getD(), a2.addFloat(d2.getC(), d2.getD())));
                    break;
                default:
                    break;
            }
