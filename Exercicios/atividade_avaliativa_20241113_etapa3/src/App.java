...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // if(valida(reta.getX1(), reta.getY1(),reta.getX2(),reta.getY2()))
        ...
        //     System.out.println("invalida");
            ...
            do{
                reta = leCoordenada();
                validCoor = Validacao.valida(reta.getX1(), reta.getY1(),reta.getX2(),reta.getY2());
            ...
            System.out.println("Retas calculadas: "+Retas.cont);   
